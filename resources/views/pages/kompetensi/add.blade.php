...
<div class="row">
    <div class="col-md-12">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            <div>
                <h3 class="fw-bold mb-3">Tambah Kompetensi</h3>
            </div>
            ...
            <div class="card-body">
                <form action="{{ route('kompetensi.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_kompetensi" class="form-control @error('kode_kompetensi') is-invalid @enderror" value="{{ old('kode_kompetensi') }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_kompetensi" class="form-control @error('nama_kompetensi') is-invalid @enderror" value="{{ old('nama_kompetensi') }}" required>
